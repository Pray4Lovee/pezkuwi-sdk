...
// TODO(https://github.com/pezkuwichain/pezkuwichain-sdk/issues/6243): Once Snowbridge supports Transact, start the flow from Ethereum and test completely e2e.
fn transfer_and_transact_in_same_xcm(
	...
	// TODO(https://github.com/pezkuwichain/pezkuwichain-sdk/issues/6197): dry-run to get local fees, for now use hardcoded value.
