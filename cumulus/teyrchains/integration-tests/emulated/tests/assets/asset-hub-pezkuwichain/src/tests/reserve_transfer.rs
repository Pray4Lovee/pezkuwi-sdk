...
/// Once we have https://github.com/pezkuwichain/pezkuwi-sdk/issues/5298,
...
fn reserve_transfer_usdt_from_asset_hub_to_para() {
	...
	// TODO(https://github.com/pezkuwichain/pezkuwi-sdk/issues/5160): When we allow payment with different assets locally, this should be the same, since
...
fn reserve_transfer_usdt_from_para_to_para_through_asset_hub() {
	...
	// TODO(https://github.com/pezkuwichain/pezkuwi-sdk/issues/5160): When we support local delivery fee payment in other assets, we don't need this.
	PenpalA::mint_foreign_asset(
		<PenpalA as Chain>::RuntimeOrigin::signed(PenpalAssetOwner::get()),
		RelayLocation::get(),
		sender.clone(),
