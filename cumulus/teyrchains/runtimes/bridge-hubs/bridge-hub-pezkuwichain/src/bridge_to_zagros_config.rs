...
pub type WithBridgeHubZagrosMessagesInstance = pallet_bridge_messages::Instance3;
impl pallet_bridge_messages::Config<WithBridgeHubZagrosMessagesInstance> for Runtime {
	type RuntimeEvent = RuntimeEvent;
	type WeightInfo = weights::pallet_bridge_messages_pezkuwichain_to_zagros::WeightInfo<Runtime>;
...
/// `WithBridgeHubZagrosMessagesInstance`.
pub type XcmOverBridgeHubZagrosInstance = pallet_xcm_bridge_hub::Instance1;
impl pallet_xcm_bridge_hub::Config<XcmOverBridgeHubZagrosInstance> for Runtime {
	type RuntimeEvent = RuntimeEvent;
