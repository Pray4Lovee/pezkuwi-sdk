...
pub mod pallet_bridge_messages_pezkuwichain_to_pezkuwichain_bulletin;
pub mod pallet_bridge_messages_pezkuwichain_to_zagros;
...
impl MessagesWeightInfoExt
	for pallet_bridge_messages_pezkuwichain_to_pezkuwichain_bulletin::WeightInfo<crate::Runtime>
{
...
impl MessagesWeightInfoExt
	for pallet_bridge_messages_pezkuwichain_to_zagros::WeightInfo<crate::Runtime>
{
	fn expected_extra_storage_proof_size() -> u32 {
...
impl TeyrchainsWeightInfoExt for pallet_bridge_teyrchains::WeightInfo<crate::Runtime> {
	fn expected_extra_storage_proof_size() -> u32 {
		bp_bridge_hub_zagros::EXTRA_STORAGE_PROOF_SIZE
	}
