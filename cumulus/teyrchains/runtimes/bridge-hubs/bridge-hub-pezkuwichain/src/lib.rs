...
construct_runtime!(
	pub enum Runtime
	{
		...
		BridgeZagrosGrandpa: pallet_bridge_grandpa::<Instance3> = 48,
		// With-Zagros teyrchain bridge module.
		BridgeZagrosTeyrchains: pallet_bridge_teyrchains::<Instance3> = 49,
		// With-Zagros messaging bridge module.
		BridgeZagrosMessages: pallet_bridge_messages::<Instance3> = 51,
		// With-Zagros bridge hub pallet.
		XcmOverBridgeHubZagros: pallet_xcm_bridge_hub::<Instance1> = 52,
...
mod benches {
	frame_benchmarking::define_benchmarks!(
		...
		// Bridge pallets
		[pallet_bridge_grandpa, ZagrosFinality]
		[pallet_bridge_teyrchains, WithinZagros]
		[pallet_bridge_messages, PezkuwichainToZagros]
		[pallet_bridge_messages, PezkuwichainToPezkuwichainBulletin]
...
impl_runtime_apis! {
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		fn benchmark_metadata(extra: bool) -> (
			...
			type WithinZagros = pallet_bridge_teyrchains::benchmarking::Pallet::<Runtime, bridge_common_config::BridgeTeyrchainZagrosInstance>;
			type PezkuwichainToZagros = pallet_bridge_messages::benchmarking::Pallet ::<Runtime, bridge_to_zagros_config::WithBridgeHubZagrosMessagesInstance>;
			type PezkuwichainToPezkuwichainBulletin = pallet_bridge_messages::benchmarking::Pallet ::<Runtime, bridge_to_bulletin_config::WithPezkuwichainBulletinMessagesInstance>;
		...
		fn dispatch_benchmark(
			...
			impl BridgeMessagesConfig<bridge_to_zagros_config::WithBridgeHubZagrosMessagesInstance> for Runtime {
				fn is_relayer_rewarded(relayer: &Self::AccountId) -> bool {
					...
					let bridged_chain_id =<Self as pallet_bridge_messages::Config<bridge_to_zagros_config::WithBridgeHubZagrosMessagesInstance>>::BridgedChain::ID;
			...
			use pallet_bridge_teyrchains::benchmarking::Config as BridgeTeyrchainsConfig;
