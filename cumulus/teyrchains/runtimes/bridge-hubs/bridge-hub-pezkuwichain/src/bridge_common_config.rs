...
pub type BridgeGrandpaZagrosInstance = pallet_bridge_grandpa::Instance3;
impl pallet_bridge_grandpa::Config<BridgeGrandpaZagrosInstance> for Runtime {
...
pub type BridgeTeyrchainZagrosInstance = pallet_bridge_teyrchains::Instance3;
impl pallet_bridge_teyrchains::Config<BridgeTeyrchainZagrosInstance> for Runtime {
	type RuntimeEvent = RuntimeEvent;
...
pub type BridgeGrandpaPezkuwichainBulletinInstance = pallet_bridge_grandpa::Instance4;
impl pallet_bridge_grandpa::Config<BridgeGrandpaPezkuwichainBulletinInstance> for Runtime {
	type RuntimeEvent = RuntimeEvent;
