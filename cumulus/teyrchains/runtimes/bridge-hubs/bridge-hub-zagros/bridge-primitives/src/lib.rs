...
/// Pallet index of `BridgePezkuwichainMessages: pallet_bridge_messages::<Instance1>`.
...
pub enum RuntimeCall {
	/// Points to the `pallet_xcm_bridge_hub` pallet instance for `BridgeHubPezkuwichain`.
	#[codec(index = 45)]
