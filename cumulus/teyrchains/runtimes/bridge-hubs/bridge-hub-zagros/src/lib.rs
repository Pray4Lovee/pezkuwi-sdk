...
construct_runtime!(
	pub enum Runtime
	{
		...
		BridgePezkuwichainGrandpa: pallet_bridge_grandpa::<Instance1> = 42,
		BridgePezkuwichainTeyrchains: pallet_bridge_teyrchains::<Instance1> = 43,
		BridgePezkuwichainMessages: pallet_bridge_messages::<Instance1> = 44,
		XcmOverBridgeHubPezkuwichain: pallet_xcm_bridge_hub::<Instance1> = 45,
...
mod benches {
	frame_benchmarking::define_benchmarks!(
		...
		[pallet_bridge_grandpa, PezkuwichainFinality]
		[pallet_bridge_teyrchains, WithinPezkuwichain]
		[pallet_bridge_messages, ZagrosToPezkuwichain]
		// Ethereum Bridge V1
...
impl_runtime_apis! {
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		fn benchmark_metadata(extra: bool) -> (
			...
			type WithinPezkuwichain = pallet_bridge_teyrchains::benchmarking::Pallet::<Runtime, bridge_to_pezkuwichain_config::BridgeTeyrchainPezkuwichainInstance>;
			type ZagrosToPezkuwichain = pallet_bridge_messages::benchmarking::Pallet ::<Runtime, bridge_to_pezkuwichain_config::WithBridgeHubPezkuwichainMessagesInstance>;
		...
		fn dispatch_benchmark(
			...
			impl BridgeMessagesConfig<bridge_to_pezkuwichain_config::WithBridgeHubPezkuwichainMessagesInstance> for Runtime {
				fn is_relayer_rewarded(relayer: &Self::AccountId) -> bool {
					...
					let bridged_chain_id =<Self as pallet_bridge_messages::Config<bridge_to_pezkuwichain_config::WithBridgeHubPezkuwichainMessagesInstance>>::BridgedChain::ID;
