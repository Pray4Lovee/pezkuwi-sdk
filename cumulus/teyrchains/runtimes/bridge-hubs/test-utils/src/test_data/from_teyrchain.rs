...
where
	Runtime: pallet_bridge_grandpa::Config<GPI>
		+ pallet_bridge_teyrchains::Config<PPI>
	...
	<Runtime as pallet_utility::Config>::RuntimeCall: From<pallet_bridge_grandpa::Call<Runtime, GPI>>
		+ From<pallet_bridge_teyrchains::Call<Runtime, PPI>>
		+ From<pallet_bridge_messages::Call<Runtime, MPI>>,
{
	...
	let submit_para_head = pallet_bridge_teyrchains::Call::<Runtime, PPI>::submit_teyrchain_heads {
		at_relay_block: (
