...
pub trait WithRemoteTeyrchainHelper {
	...
	type GPI: 'static;
	/// Instance of the `pallet-bridge-teyrchains`, used to bridge with remote teyrchain.
	type PPI: 'static;
	/// Instance of the `pallet-bridge-messages`, used to bridge with remote teyrchain.
	type MPI: 'static;
