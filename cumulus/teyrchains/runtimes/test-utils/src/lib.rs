...
impl<
		Runtime: frame_system::Config + cumulus_pallet_teyrchain_system::Config + pallet_timestamp::Config,
...
impl<
		Runtime: pallet_xcm::Config + cumulus_pallet_teyrchain_system::Config,
		AllPalletsWithoutSystem,
	> RuntimeHelper<Runtime, AllPalletsWithoutSystem>
{
...
impl<
		Runtime: cumulus_pallet_teyrchain_system::Config + pallet_xcm::Config,
		AllPalletsWithoutSystem,
	> RuntimeHelper<Runtime, AllPalletsWithoutSystem>
{
	#[deprecated(
