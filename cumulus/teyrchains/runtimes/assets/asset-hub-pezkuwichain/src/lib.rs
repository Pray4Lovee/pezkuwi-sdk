...
pub type ToZagrosXcmRouterInstance = pallet_xcm_bridge_hub_router::Instance3;
impl pallet_xcm_bridge_hub_router::Config<ToZagrosXcmRouterInstance> for Runtime {
	type RuntimeEvent = RuntimeEvent;
...
construct_runtime!(
	pub enum Runtime
	{
		...
		// Bridge utilities.
		ToZagrosXcmRouter: pallet_xcm_bridge_hub_router::<Instance3> = 45,
...
mod benches {
	frame_benchmarking::define_benchmarks!(
		...
		[pallet_xcm_bridge_hub_router, ToZagros]
