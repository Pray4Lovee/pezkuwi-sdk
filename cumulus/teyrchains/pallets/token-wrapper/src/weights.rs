...
// --steps=50
// --repeat=20
// --output=/home/mamostehp/Pezkuwi-SDK/cumulus/teyrchains/pallets/token-wrapper/src/weights.rs
...
/// Weight functions needed for `pallet_token_wrapper`.
pub trait WeightInfo {
	fn wrap() -> Weight;
	fn unwrap() -> Weight;
}

/// Weights for `pallet_token_wrapper` using the Substrate node and recommended hardware.
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn wrap() -> Weight {
		...
		Weight::from_parts(79_735_000, 3675)
	...
	fn unwrap() -> Weight {
		...
		//  Measured:  `676`
		//  Estimated: `3675`
		// Minimum execution time: 109_789_000 picoseconds.
		Weight::from_parts(113_055_000, 3675)
