...
use frame_support::pallet_prelude::{MaybeSerializeDeserialize, Parameter, RuntimeDebug};
...
pub mod pallet {
	...
	#[pallet::config]
	pub trait Config:
		frame_system::Config + pallet_nfts::Config<ItemId = u32> + pallet_identity_kyc::Config
	{
