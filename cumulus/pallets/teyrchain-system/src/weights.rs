...
// compiled
// --output
// pallets/teyrchain-system/src/weights.rs
// --steps
// 50
// --repeat
// 20
...
/// Weight functions needed for cumulus_pallet_teyrchain_system.
pub trait WeightInfo {
	fn enqueue_inbound_downward_messages(n: u32, ) -> Weight;
}

/// Weights for cumulus_pallet_teyrchain_system using the Substrate node and recommended hardware.
