...
//! `cumulus-pallet-teyrchain-system` is a base pallet for Cumulus-based teyrchains.
//!
...
pub mod pallet {
	...
	#[pallet::config]
	pub trait Config: frame_system::Config<OnSetCode = TeyrchainSetCode<Self>> {
...
impl<T: Config> frame_system::SetCode<T> for TeyrchainSetCode<T> {
