...
cargo build --release -p cumulus-test-service --bin test-teyrchain -p pezkuwi --bin pezkuwi-prepare-worker --bin pezkuwi-execute-worker --bin pezkuwi -p pezkuwi-teyrchain-bin --bin pezkuwi-teyrchain
