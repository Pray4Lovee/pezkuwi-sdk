...
//! `TeyrchainInherentDataExt` trait in `cumulus-client-teyrchain-inherent` that helps with this.
...
impl sp_inherents::InherentDataProvider for TeyrchainInherentData {
