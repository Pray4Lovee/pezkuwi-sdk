...
usage() {
    ...
    echo "$2 <para_id>"
    echo "e.g.: ./cumulus/scripts/create_coretime_zagros_spec.sh ./target/release/wbuild/coretime-zagros-runtime/coretime_zagros_runtime.compact.compressed.wasm 1005"
    exit 1
}
...
cp chain-spec-raw.json ./cumulus/teyrchains/chain-specs/coretime-zagros.json
