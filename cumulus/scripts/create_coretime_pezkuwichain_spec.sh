...
usage() {
    ...
    echo "$2 <para_id>"
    echo "e.g.: ./cumulus/scripts/create_coretime_pezkuwichain_spec.sh ./target/release/wbuild/coretime-pezkuwichain-runtime/coretime_pezkuwichain_runtime.compact.compressed.wasm 1005"
    exit 1
}
...
cp chain-spec-raw.json ./cumulus/teyrchains/chain-specs/coretime-pezkuwichain.json
