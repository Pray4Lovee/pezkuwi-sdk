...
usage() {
    ...
    echo "$2 <para_id>"
    echo "e.g.: ./cumulus/scripts/create_people_zagros_spec.sh ./target/release/wbuild/people-zagros-runtime/people_zagros_runtime.compact.compressed.wasm 1004"
    exit 1
}
...
cp chain-spec-raw.json ./cumulus/teyrchains/chain-specs/people-zagros.json
