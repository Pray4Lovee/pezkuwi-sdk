...
usage() {
    ...
    echo "$2 <para_id>"
    echo "e.g.: ./cumulus/scripts/create_people_pezkuwichain_spec.sh ./target/release/wbuild/people-pezkuwichain-runtime/people_pezkuwichain_runtime.compact.compressed.wasm 1004"
    exit 1
}
...
cp chain-spec-raw.json ./cumulus/teyrchains/chain-specs/people-pezkuwichain.json
