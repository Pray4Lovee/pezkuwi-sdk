...
//! for Substrate based chains such as Pezkuwi, Kusama and a growing number of teyrchains and
...
//! # If you run into issues building, you likely are missing deps defined in https://github.com/pezkuwichain/docs.pezkuwichain.io/install/
//! ```
//!
//! ### Run in a container
//!
...
//!
//! You can read more about the [SS58 format in the Substrate Docs](https://github.com/pezkuwichain/docs.pezkuwichain.io/reference/address-formats/) and see the list of reserved prefixes in the [SS58 Registry](https://github.com/paritytech/ss58-registry).
//!
