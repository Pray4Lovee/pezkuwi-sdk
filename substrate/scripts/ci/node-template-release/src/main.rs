...
const SUBSTRATE_GIT_URL: &str = "https://github.com/pezkuwichain/pezkuwichain-sdk.git";
...
frame-system = { version = "4.0.0-dev", default-features = true, git = "https://github.com/pezkuwichain/pezkuwichain-sdk.git", rev = "commit_id" }
sp-io = { version = "7.0.0", git = "https://github.com/pezkuwichain/pezkuwichain-sdk.git", rev = "commit_id" }
