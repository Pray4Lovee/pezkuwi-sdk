...
use xcm_config::{
	...
	TrustBackedAssetsPalletLocation, ZagrosLocation, XcmOriginToTransactDispatchOrigin,
};
...
pub type ToPezkuwichainXcmRouterInstance = pallet_xcm_bridge_hub_router::Instance1;
impl pallet_xcm_bridge_hub_router::Config<ToPezkuwichainXcmRouterInstance> for Runtime {
	type RuntimeEvent = RuntimeEvent;
...
construct_runtime!(
	pub enum Runtime
	{
		...
		// Bridge utilities.
		ToPezkuwichainXcmRouter: pallet_xcm_bridge_hub_router::<Instance1> = 34,
...
mod benches {
	frame_benchmarking::define_benchmarks!(
		...
		[pallet_xcm_bridge_hub_router, ToPezkuwichain]
		[pallet_asset_conversion_ops, AssetConversionMigration]
		// XCM
		...
		fn dispatch_benchmark(
			...
			impl pallet_xcm_benchmarks::generic::Config for Runtime {
				...
				fn transact_origin_and_runtime_call() -> Result<(Location, RuntimeCall), BenchmarkError> {
					Ok((ZagrosLocation::get(), frame_system::Call::remark_with_event { remark: vec![] }.into()))
				}
