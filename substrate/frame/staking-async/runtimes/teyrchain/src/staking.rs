...
parameter_types! {
	...
	/// https://github.com/pezkuwichain/pezkuwichain-sdk/pull/8704, the maximum of which being around 1mb
...
mod tests {
	...
	/// 	cargo test --release -p pallet-staking-async-teyrchain-runtime \
