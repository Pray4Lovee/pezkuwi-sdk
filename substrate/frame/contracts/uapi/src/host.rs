...
pub trait HostFn: private::Sealed {
	...
	/// # Parameters
	///
	/// - `msg`: The message, should be decodable as a [VersionedXcm](https://docs.pezkuwichain.io/sdk/master/staging_xcm/enum.VersionedXcm.html),
	///   traps otherwise.
	/// - `output`: A reference to the output data buffer to write the [Outcome](https://docs.pezkuwichain.io/sdk/master/staging_xcm/v3/enum.Outcome.html)
	///
	/// # Return
	///
	...
	/// # Parameters
	///
	/// - `dest`: The XCM destination, should be decodable as [VersionedLocation](https://docs.pezkuwichain.io/sdk/master/staging_xcm/enum.VersionedLocation.html),
	///   traps otherwise.
	/// - `msg`: The message, should be decodable as a [VersionedXcm](https://docs.pezkuwichain.io/sdk/master/staging_xcm/enum.VersionedXcm.html),
	///   traps otherwise.
	///
