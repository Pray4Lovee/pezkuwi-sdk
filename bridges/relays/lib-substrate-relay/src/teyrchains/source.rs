...
#[derive(Clone)]
pub struct TeyrchainsSource<P: SubstrateTeyrchainsPipeline, SourceRelayClnt> {
	client: SourceRelayClnt,
	max_head_id: RequiredHeaderIdRef<P::SourceTeyrchain>,
}

impl<P: SubstrateTeyrchainsPipeline, SourceRelayClnt: Client<P::SourceRelayChain>>
...
#[async_trait]
impl<P: SubstrateTeyrchainsPipeline, SourceRelayClnt: Client<P::SourceRelayChain>> RelayClient
