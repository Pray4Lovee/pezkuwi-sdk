...
//! > [#pezkuwi-sdk#1378](https://github.com/pezkuwichain/pezkuwichain-sdk/pull/1378) is meant to
...
//! > simplify the above scenario. See [this](https://github.com/pezkuwichain/pezkuwichain-sdk/issues/3743)
